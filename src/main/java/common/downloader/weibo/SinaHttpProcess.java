...
public class SinaHttpProcess  {
	...
	private HttpClient httpClient(CrawlTask html) {
	...
	public byte[] postRequest(CrawlTask html, List<NameValuePair> form_data, String refererURL, String agent){
	...
	private void getContent(CrawlTask html) {
