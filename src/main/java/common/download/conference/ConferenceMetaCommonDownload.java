 ...
 * @author grs
 */
public class ConferenceMetaCommonDownload extends GenericMetaCommonDownload<ConferenceData> implements Runnable {
	private static final Logger LOGGER = LoggerFactory.getLogger(ConferenceMetaCommonDownload.class);

	public ConferenceMetaCommonDownload(SearchKey key) {
		super(key);
	}

	public void process() {
		List<ConferenceData> alllist = new ArrayList<ConferenceData>();
