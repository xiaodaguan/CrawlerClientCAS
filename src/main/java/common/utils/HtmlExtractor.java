...
public class HtmlExtractor {
	 ...
	 * @throws SAXException 
	 */
	public String extractContent(String html, String charset) throws SAXException, IOException {
	 ...
	 */
	public ExtractResult extract(String html, String charset, String url) throws Exception{
		Node domTree = dom.ini(html, charset);
		if (domTree == null) {
			return null;
		}
