...
public class WeixinOracleService extends OracleService<WeixinData> {
    ...
    private static final String jasql = "insert into " + TABLE + "(" + "title, " + "author," + "pubtime," + "source," + "url," + "inserttime," + "search_keyword," + "category_code," + "md5," + "content," + "brief," + "site_id," + "img_url," + "same_num, " + "same_url, " + "read_num, " + "like_num, " + "gongzhong_id, " + "create_time" + ") values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private static final String samesql = "insert into " + SAME_TABLE + "(" + "md5," + "title," + "source," + "url," + "insert_time," + "pubtime," + "content," + "img_url," + "data_id) values(?,?,?,?,?,?,?,?,?)";
