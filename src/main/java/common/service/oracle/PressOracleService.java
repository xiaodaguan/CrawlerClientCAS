...
import common.extractor.xpath.client.search.sub.YidianExtractor;
...
public class PressOracleService extends OracleService<PressData> {
	private static final Logger LOGGER = LoggerFactory.getLogger(PressOracleService.class);


    private static final String TABLE = "press_data";
    ...
    private static final String SAME_TABLE = "press_data_same";
