...
public class WeiboMonitorXpathExtractor extends XpathExtractor<WeiboData> implements WeiboMonitorExtractorAttribute {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WeiboMonitorXpathExtractor.class);
    ...
    public void templateUser(UserData data, HtmlInfo html, boolean first, String... keyword) throws SAXException, IOException {
        ...
        if (first) {
            ...
            parseAuthorUrl(data, domtree, comp.getComponents().get("author_url"), html.getOrignUrl());
    ...
    public String templateListPage(List<WeiboData> list, HtmlInfo html, int page, String... keyword) throws SAXException, IOException {
        ...
        String nextPage = parseNext(domtree, comp.getComponents().get("weibo_next"), new String[]{keyword[1], list.get(list.size() - 1).getMid(), StringUtil.regMatcher(html.getContent(), "<AUTHORID>", "</AUTHORID>"), page + "", list.get(0).getMid(), html.getOrignUrl()});
        domtree = null;
        return nextPage;
    }
    ...
    protected void weiboAttributeSet(List<WeiboData> list, int siteId, String... keyword) {
        for (WeiboData data : list) {
            ...
            data.setInserttime(new Date());
            data.setSearchKey(keyword[3]);
            data.setAuthorurl(keyword[3]);
            data.setAuthor(keyword[4]);
        }
    }
    ...
    @Override
    public void parseWeiboMid(List<WeiboData> list, Node domtree, Component component, String... args) {
    ...
    @Override
    public void parseWeiboContentUrl(List<WeiboData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseWeiboCommentNum(List<WeiboData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRttContent(List<WeiboData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    public void parseCommpany(UserData data, Node dom, Component component, String... args) {
        ...
        if (nl.item(0) != null) data.setCompany(nl.item(0).getTextContent());
    }

    @Override
    public void parseRegistTime(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);

        if (nl.item(0) != null) data.setRegistTime(nl.item(0).getTextContent());
    }
    ...
    public void parseBirth(UserData data, Node dom, Component component, String... args) {
        ...
        if (nl.item(0) != null) data.setBirth(nl.item(0).getTextContent());
    }
    ...
    public void parseNick(UserData data, Node dom, Component component, String... args) {
        ...
        if (nl.item(0) != null) data.setNick(nl.item(0).getTextContent());
    }
    ...
    public void parseAuthorId(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setAuthorId(nl.item(0).getTextContent());
    }
    ...
    public void parseAddress(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setAddress(nl.item(0).getTextContent());
    }
    ...
    public void parseCertify(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setCertify(nl.item(0).getTextContent());
    }
    ...
    public void parseSex(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setSex(nl.item(0).getTextContent());
    }
    ...
    public void parseWeiboNum(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setWeiboNum(Integer.parseInt(nl.item(0).getTextContent()));
    }
    ...
    public void parseAttentNum(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setAttentNum(Integer.parseInt(nl.item(0).getTextContent()));
    }
    ...
    public void parseFansNum(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setFansNum(Integer.parseInt(nl.item(0).getTextContent()));
    }
    ...
    public void parseAuthorImg(UserData data, Node dom, Component component, String... strings) {
        ...
        if (nl.item(0) != null) data.setAuthorImg(nl.item(0).getTextContent());
    }

    @Override
    public void parseAuthorUrl(UserData data, Node dom, Component component, String... args) {
        data.setAuthorUrl(args[0]);
//		NodeList nl = commonList(component.getXpath(), dom);
//		if(nl.item(0)!=null)
//			data.setAuthorUrl(nl.item(0).getTextContent());
    ...
    public void parseAuthor(UserData data, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), dom);
        if (nl.item(0) != null) data.setAuthor(nl.item(0).getTextContent());
    }
    ...
    @Override
    public void parseRelationWeiboUrl(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationFansUrl(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationFollowUrl(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationWeiboNum(List<UserData> list, Node domtree, Component component, String... content) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationFansNum(List<UserData> list, Node domtree, Component component, String... content) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationAttentNum(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationAddress(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationAuthorImg(List<UserData> list, Node domtree, Component component, String... content) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), domtree, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void parseRelationAuthor(List<UserData> list, Node domtree, Component component, String... args) {
        if (component == null) return;
        NodeList nl = commonList(component.getXpath(), domtree);
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    public void parseWeiboAuthor(List<WeiboData> list, Node dom, Component component, String... args) {
        if (component == null) return;
        NodeList nl = head(component.getXpath(), dom, list.size(), component.getName());
        if (nl == null) return;
        for (int i = 0; i < nl.getLength(); i++) {
    ...
    @Override
    public void processPage(WeiboData data, Node domtree, Map<String, Component> map, String... args) {
    }

    @Override
    public void processList(List<WeiboData> list, Node domtree, Map<String, Component> components, String... args) {
    }
