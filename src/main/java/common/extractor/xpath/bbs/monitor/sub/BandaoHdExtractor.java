...
import common.download.SimpleDataCommonDownload;
...
public class BandaoHdExtractor extends BbsMonitorXpathExtractor {
    private static final Logger LOGGER = LoggerFactory.getLogger(BandaoHdExtractor.class);
