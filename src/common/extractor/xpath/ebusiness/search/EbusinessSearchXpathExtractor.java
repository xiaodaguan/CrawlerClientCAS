...
public class EbusinessSearchXpathExtractor extends XpathExtractor<EbusinessData> implements
	...
	@Override
	public String templateContentPage(EbusinessData data, HtmlInfo html, int page, String... keyword) throws SAXException, IOException {
	 ...
	 * @throws SAXException 
	 */
	public void templateOwnerPage(EbusinessData data, HtmlInfo html, int page, String... keyword) throws SAXException, IOException {
